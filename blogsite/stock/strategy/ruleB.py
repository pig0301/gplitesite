...
def is_good_stock(row):
    ...
    isPrice_Rule2 = (row['ma10'] < row['ma5'] < row['ma10'] * 1.05)
    isPrice_Rule3 = (row['ma20'] < row['ma10'] < row['ma20'] * 1.05)
    isMacd_Rule3 = (row['macd'] * 100 / row['close'] < MAX_MACD_RATE)

    return isPrice_Rule1 and isPrice_Rule2 and isPrice_Rule3 and isMacd_Rule3