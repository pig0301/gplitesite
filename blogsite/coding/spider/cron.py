...
def query_storage_as_normal(mode=constants.NORMAL_MODE):
    dttm = timezone.now()
...
def query_storage_with_clean():
    query_storage_as_normal(mode=constants.CLEAN_MODE)


def query_storage_with_save():
    query_storage_as_normal(mode=constants.SAVE_MODE)
