...
def query_storage_as_normal():
    icbc_queue.enqueue(query_storage, constants.NORMAL_MODE)


def query_storage_with_clean():
    icbc_queue.enqueue(query_storage, constants.CLEAN_MODE)


def query_storage_with_save():
    icbc_queue.enqueue(query_storage, constants.SAVE_MODE)