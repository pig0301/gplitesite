...
if SERVER_TYPE == 'DEVELOP':
    ...
    CRONJOBS = [
        ...
        ('35 16 * * *', 'stock.cron.update_daily_quotes', '>> /data/share/log/gplitesite/cron/stock_daily_update.log'),
        ('55 16 * * *', 'stock.cron.run_pick_strategy', '>> /data/share/log/gplitesite/cron/stock_daily_update.log'),
    ]
