...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'libs.functions.template_extra_context'
            ],
        },
    },
]
...
if SERVER_TYPE == 'DEVELOP':
    ...
    CRONJOBS = [
        ...
        ('55 16 * * *', 'stock.cron.update_daily_quotes', '>> /data/share/log/gplitesite/cron/stock_daily_update.log'),
        ('15 17 * * *', 'stock.cron.run_pick_strategy', '>> /data/share/log/gplitesite/cron/stock_daily_update.log'),
    ]
